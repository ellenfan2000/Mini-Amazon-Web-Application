...
if __name__ == '__main__':
    ...
    orders = [Order(buyer = 2, product_id = 0, status = 'packed', package = 1, rate = 1), 
              Order(buyer = 2, product_id = 1, status = 'packed', package = 2, rate = 3), 
              Order(buyer = 2, product_id = 2, status = 'packed', package = 3, rate = None), 
              Order(buyer = 2, product_id = 3, status = 'packed', package = 4, rate = 5), 
              Order(buyer = 1, product_id = 4, status = 'packed', package = 5, rate = 2), 
              Order(buyer = 1, product_id = 5, status = 'packed', package = 6, rate = 6), 
              Order(buyer = 1, product_id = 0, status = 'packed', package = 7, rate = 8), 
              Order(buyer = 1, product_id = 1, status = 'packed', package = 8, rate = 1), 
              Order(buyer = 1, product_id = 2, status = 'packed', package = 9, rate = 0), 
              ]
